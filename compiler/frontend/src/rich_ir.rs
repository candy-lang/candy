...
impl RichIrBuilder {
    ...
    pub fn push_simple(&mut self, text: impl AsRef<str>) -> Range<Offset> {
        self.push(text, None, EnumSet::empty())
    }
    pub fn push(
        &mut self,
        text: impl AsRef<str>,
...
impl RichIr {
    ...
    pub fn for_cst(module: &Module, cst: &CstResult) -> Option<Self> {
        ...
        Some(Self::for_ir("CST", module, None, |builder| {
            match cst {
                Ok(cst) => cst.build_rich_ir(builder),
